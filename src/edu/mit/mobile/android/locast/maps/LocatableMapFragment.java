...
public class LocatableMapFragment extends SupportMapFragment implements OnMarkerClickListener,
    ...
    protected static final String[] PROJECTION = new String[] { ContentItem._ID,
            Locatable.Columns.COL_LATITUDE, Locatable.Columns.COL_LONGITUDE,
            Titled.Columns.COL_TITLE, Titled.Columns.COL_DESCRIPTION };
    ...
    protected MarkerOptions getMarker(Cursor c) {
        ...
        mo.position(new LatLng(c.getDouble(c.getColumnIndex(Locatable.Columns.COL_LATITUDE)), c
                .getDouble(c.getColumnIndex(Locatable.Columns.COL_LONGITUDE))));
        mo.title(c.getString(c.getColumnIndex(Titled.Columns.COL_TITLE)));
        mo.snippet(c.getString(c.getColumnIndex(Titled.Columns.COL_DESCRIPTION)));
